...
class ShareContactSheetWidget extends StatefulWidget {
  ...
  @override
  _ShareContactSheetWidgetState createState() =>
      _ShareContactSheetWidgetState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return AuthUserStreamWidget(
      builder: (context) => FutureBuilder<ProfilesRecord>(
        future: ProfilesRecord.getDocumentOnce(currentUserDocument!.profile!),
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    final contactsCreateData =
                                      ...
                                      contactImage: contactCardProfilesRecord
                                          .profileImage,
                                      companyLogo:
                                          contactCardProfilesRecord.companyLogo,
                                    );
