          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => EditContactWidget(
                contactRef: params.getParam('contactRef',
                    ParamType.DocumentReference, false, ['users', 'contacts']),
            ...
            FFRoute(
              ...
              requireAuth: true,
              asyncParams: {
                'profile': getDoc(['profiles'], ProfilesRecord.serializer),
              },
            ...
            FFRoute(
              ...
              path: 'vCard',
              requireAuth: true,
              builder: (context, params) => VCardWidget(
                profile: params.getParam('profile', ParamType.DocumentReference,
                    false, ['profiles']),
              ),
            ),
            FFRoute(
              name: 'contactShared',
              path: 'contactShared',
              builder: (context, params) => ContactSharedWidget(),
            ),
            FFRoute(
              name: 'Beeniecard',
              path: 'beeniecard/:cardID',
              builder: (context, params) => BeeniecardWidget(
            ...
            FFRoute(
              ...
              requireAuth: true,
              builder: (context, params) => ActivateWidget(
                cardID: params.getParam('cardID', ParamType.String),
              ),
            ),
            FFRoute(
              ...
              asyncParams: {
                'beenieCard':
                    getDoc(['beeniecards'], BeeniecardsRecord.serializer),
              },
              builder: (context, params) => ActivateSuccessWidget(
                beenieCard: params.getParam('beenieCard', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'contactAdded',
              ...
              asyncParams: {
                'contactDoc':
                    getDoc(['users', 'contacts'], ContactsRecord.serializer),
              },
              builder: (context, params) => ContactAddedWidget(
                contactDoc: params.getParam('contactDoc', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'ResetPassword',
            ...
            FFRoute(
              ...
              builder: (context, params) => EmailAuthenticationWidget(),
            ),
            FFRoute(
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/MicrosoftTeams-image_(40).png',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
