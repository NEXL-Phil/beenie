...
class LightModeTheme extends FlutterFlowTheme {
  late Color primaryColor = const Color(0xFFF6BE00);
  late Color secondaryColor = const Color(0xFF00D2FC);
  late Color tertiaryColor = const Color(0xFF0041D2);
  late Color alternate = const Color(0xFFFF5963);
  late Color primaryBackground = const Color(0xFFF3F7FE);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color primaryText = const Color(0xFF03193F);
