...
import 'beeniecard_model.dart';
export 'beeniecard_model.dart';
...
class _BeeniecardWidgetState extends State<BeeniecardWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BeeniecardModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.profileReference = await actions.getBeeCardProfile(
        widget.cardID!,
      );
      if (_model.profileReference != null) {
        context.pushNamed(
          'PublicProfileC',
          params: {
            'profile': serializeParam(
              _model.profileReference,
